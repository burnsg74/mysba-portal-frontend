...
export {
  PORTAL_URL, BASE_API_URL, PORTAL_SIGNUP_URL, PORTAL_API_URL, OKTA_CLIENT_ID, OKTA_DOMAIN, DISTRICT_URL, CLS_URL, OKTA_IDP, LOAN_URL, LOAN_CLIENT_ID, LOAN_CLIENT_SECRET
};