...
let learningCenterCourses = {
  FinancingYourBusiness             : new LearningCenterCourse(1, "Financing Your Business", "Assess your financing needs and discover financing options for your business.", "/assets/learning-center-financing-your-business.png", "https://learn.sba.gov/learning-center-launch/learning-center-financing-your-business", [{
    id         : 1,
    type       : "video",
  ...
  CompetitiveAdvantage              : new LearningCenterCourse(2, "Competitive Advantage", "Leverage the uniqueness of your business to develop your competitive advantage.", "/assets/learning-center-competitive-advantage.png", "https://learn.sba.gov/learning-center-market/learning-center-competitive-advantage", [{
    id         : 1,
    type       : "video",
  ...
  GovernmentAsYourCustomer          : new LearningCenterCourse(3, "Government As Your Customer", "As an entrepreneur you're constantly on the lookout for new\n" + "customers and untapped markets to grow your business. One potential\n" + "market for your product or service is the government. This topic\n" + "within the Government Contracting course will guide you through what\n" + "you need to know to understand the government as a customer.", "/assets/learning-center-goverment-as-your-customer.png", "https://learn.sba.gov/lc-government-contracting/lc-government-as-your-customer", [{
    id         : 1,
    type       : "infographic",
  ...
  LegalRequirements                 : new LearningCenterCourse(4, "Legal Requirements", "Review how small business legal requirements can impact your business.", "/assets/learning-center-legal-requirements.png", "https://learn.sba.gov/learning-center-plan/learning-center-learning-requirements", [{
    id         : 1,
    type       : "video",
  ...
  PricingModelsForSuccessfulBusiness: new LearningCenterCourse(5, "Pricing Models for Successful Business", "Set prices, calculate costs, assess competitors and much more.", "/assets/learning-center-pricing-models-for-successful-business.png", "https://learn.sba.gov/learning-center-grow/learning-center-pricing-models-for-successful-business", [{
    id         : 1,
    type       : "video",
...
learningCenterCoursesByPath["/dashboard"] = [learningCenterCourses.CompetitiveAdvantage,
  learningCenterCourses.FinancingYourBusiness];
