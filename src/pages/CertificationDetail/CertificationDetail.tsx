...
import CertificationPill from "src/components/CertificationPill/CertificationPill";
...
const CertificationDetail = () => {
  ...
  const [showManageCertificationModal, setShowManageCertificationModal] = useState<boolean>(false);
  ...
  const handleManageCertificationModalClose = () => {
    setShowManageCertificationModal(false);
  };
  ...
  return (<>
      <div data-testid="page-certification-details" className={`${styles.container}`}>
        ...
        <div className={`grid-row ${styles.titleBanner}`}>
          ...
          <CertificationPill certification={certification} />
        </div>
