...
import styles from "src/pages/CertificationView/CertificationView.module.css";
...
const CertificationView = () => {
    ...
    return (
        <div className={`${styles['container']}`}>
            ...
            <div className="usa-alert usa-alert--warning Certifications-alert">
            ...
            <div className={`grid-row ${styles['title-banner']}`}>
                ...
                <div className={`grid-col`}>
                    <span className={`${styles['title']}`}> {certification?.name ?? 'Default Value'} </span>
                </div>
                <div className={`grid-col-auto ${styles['badge']}`}>
                    <svg className={`usa-icon ${styles['title-icon']}`} aria-hidden="true"
            ...
            <Field label="Certification Number" value={certification?.number.toString() ?? ''}/>
            <Field label="Issue Date" value={certification?.issue_at ?? ''}/>
            <Field label="Expiration/Renewal Date" value={certification?.expire_at ?? ''}/>
            <Field label="North American Industry Classification System" value={certification?.system ?? ''}/>
            <div className={`${styles['subtitle']}`}>
                Ownership
            </div>
