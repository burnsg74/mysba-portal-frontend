      ...
      <div className="grid-row">
        <div className="grid-col-12">
          <Alert type={"info"}
                 ...
                 message={<>
                   Certifications aren’t shown in MySBA Home yet, but support is coming soon.
                   Visit <a href="https://certify.sba.gov" target="_blank"
                            rel="noopener noreferrer">certify.sba.gov</a> to
                   apply for and manage certifications.
                 </>} />
        </div>
      </div>
      ...
      <div data-testid="page-dashboard">
        <div className={`${styles.dashboardContent}`}>
          ...
          {user.certifications?.map((certification) => {
            ...
            return (<div className={styles.alertContainer} key={certification.certification_id}>
          ...
          <div className={`grid-row ${styles.cardsContainer}`}>
            <div className="grid-col-12 desktop:grid-col-4">
              <div className="usa-card__container">
                <div className="usa-card__header">
                  <h4 className="usa-card__heading">Loans</h4>
                </div>
                ...
                <div className="usa-card__footer">
                  <a href="#" className="usa-button usa-button--outline">Learn More</a>
                  <a href="#" className="usa-button">Apply</a>
                </div>
              </div>
            </div>
            <div className="grid-col-12 desktop:grid-col-4">
              <div className="usa-card__container">
                <div className="usa-card__header">
                  <h4 className="usa-card__heading">Certifications</h4>
                </div>
                <div className="usa-card__media">
                  <div className="usa-card__img">
                    <img
                      src={CardCertificationsImg}
                      alt="Certifications Card"
                    />
                  </div>
                </div>
                <div className="usa-card__body">
                  <p>The federal government uses special programs to help small businesses win at least at 23% of
                    federal contracting dollars yearly.</p>
                </div>
                <div className="usa-card__footer">
                  <a href="#" className="usa-button usa-button--outline">Learn More</a>
                  <a href="#" className="usa-button">Apply</a>
            ...
            <div className="grid-col-12  desktop:grid-col-4">
              <div className="usa-card__container">
                <div className="usa-card__header">
                  <h4 className="usa-card__heading">Disaster Loans</h4>
                </div>
                <div className="usa-card__media">
                  <div className="usa-card__img">
                    <img
                      src={CardDisasterLoansImg}
                      alt="Disaster Loans Card"
                    />
                  </div>
                </div>
                <div className="usa-card__body">
