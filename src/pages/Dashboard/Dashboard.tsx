                ...
                <div className="grid-col">
                    ...
                    <div className={`banner ${styles["banner"]}`}>
                        <div className={`${styles["welcome-message"]}`}>
                            {user.profile &&
                                <span> Hi, <span className="username"> {user.profile.first_name}</span></span>}
                        </div>
                        <div className={`${styles["mysba-message"]}`}>
                            Welcome to your MySBA Dashboard
                        </div>
                        <img
                                ...
                                {user.businesses && user.businesses.map((business, index) => (
                                    <React.Fragment key={index}>
                                        <div className={`${styles["business__container"]}`}>
                                            ...
                                            <span className={`${styles["business__title"]}`}>{business.name}</span>
                                        </div>
                                        <div className={`grid-row ${styles["cert-header__row"]}`}>
                                            ...
                                            <div className={`grid-col ${styles["certifications-header__link"]}`}>
                                                <Link to='/certifications'
                                                      className={`float-right ${styles["certifications-header__link"]}`}>View</Link>
                                            </div>
                                        </div>
                                        {/* certifications  */}
                                        <div className="grid-row">
