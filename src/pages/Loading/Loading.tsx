...
const Loading = () => {
  ...
  const fetchUserDataFromMock = async () => {
    try {
      ...
      throw error; // Depending on how you want to handle the error, you can throw it or return a default value
    }
  };
