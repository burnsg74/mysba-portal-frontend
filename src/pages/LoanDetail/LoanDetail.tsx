...
const LoanDetail = () => {
  ...
  return (<div data-testid="page-loan-details" className={`main-container ${styles.container}`}>
    ...
    <div className={`${styles.categoryGroup}`}>
      ...
      {(loan.amount_to_be_current !== null && loan.amount_to_be_current !== undefined) && (loan.program_description === '504' ? (
