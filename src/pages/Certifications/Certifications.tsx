                ...
                <div className={`grid-col ${styles['container']}`}>
                    <div className="usa-alert usa-alert--warning Certifications-alert">
                        ...
                        <span className="usa-alert__text">
                            {showModal} Your Veteran-Owned Small Business must be renewed by 12/15/2023
                        </span>
                        </div>
                    </div>
                    ...
                    <div className="Certifications-content">
                        <ul className="usa-card-group Certifications-certs">
                                ...
                                <React.Fragment key={index}>
                                    <li className="usa-card tablet-lg:grid-col-6 widescreen:grid-col-4">
                                        <div className="usa-card__container">
                                            <div className="usa-card__header Certifications-usa-card__header">
                                                <div className="grid-row">
                                                    <div className="grid-col">
                                                    ...
                                                    <div className="grid-col-auto">
                                                        <Link to={`/certification/${certification.id}`}
                                                              className="usa-button">Details</Link>
                                                    </div>
                                                </div>
                                            </div>
