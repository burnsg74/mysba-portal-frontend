...
export const Help: React.FC = () => {
  ...
  return (
    <div data-testid="page-help" className={`main-container ${styles.mainContainer}`}>
      <div className={`${styles.container}`}>
        ...
        <div className={`${styles.faqContainer}`}>
          {FrequentlyAskedQuestions.map(faq => (
            <div key={faq.id} className="usa-accordion usa-accordion--bordered">
              ...
              <div id={`a${faq.id}`} className={`usa-accordion__content usa-prose ${styles.faqContent}`} hidden>
        ...
        <div className={`${styles.alertWrapper}`}>
          <Alert
            ...
            message={
              <>
                {t('Help is available via phone and email. Contact us today:')}
                <br />
                <ul className="margin-0">
                  <li>
                    <a href="tel:8664434170">Tel: 866-443-4170</a>
                    <br />
                  </li>
                  <li>
