...
describe("ModalComponent", () => {
  ...
  it("renders step indicators and prevModal is called when completed step is clicked", () => {
    render(<ModalComponent title="Step Modal" totalSteps={3} completedSteps={1} prevModal={prevModal}
                           onClose={onClose} />);
  ...
  it("renders content title and message when provided", () => {
    render(<ModalComponent title="Content Modal" contentTitle="Content Title"
                           contentMessage="This is a content message." onClose={onClose} />);
