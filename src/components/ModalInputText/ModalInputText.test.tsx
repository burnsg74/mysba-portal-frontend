...
import ModalInputText from './ModalInputText'; // Adjust the import path as necessary
...
describe('Field Component', () => {
  it('renders the label and value correctly', () => {
    ...
    render(<ModalInputText label={label} value={value} />);
  ...
  it('supports ReactNode as value', () => {
    ...
    render(<ModalInputText label={label} value={nodeValue} />);
