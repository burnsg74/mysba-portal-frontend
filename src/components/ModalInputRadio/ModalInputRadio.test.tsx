...
import ModalInputRadio from './ModalInputRadio'; // Adjust the import path as necessary
...
describe('Field Component', () => {
  it('renders the label and value correctly', () => {
    ...
    render(<ModalInputRadio label={label} value={value} />);
  ...
  it('supports ReactNode as value', () => {
    ...
    render(<ModalInputRadio label={label} value={nodeValue} />);
